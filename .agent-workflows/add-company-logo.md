...
Add a company logo to `assets/companies/` as a matching SVG and PNG pair.

## Inputs

The user may provide:

- A company name, such as "SpaceX", "NVIDIA", or "Google".
- A stem or filename to use. If none is provided, derive one from the company name using lowercase letters and no spaces, such as `spacex`.
- A source URL.
- A color treatment such as black or grayscale.
